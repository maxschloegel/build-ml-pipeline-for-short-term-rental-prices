...
def test_proper_boundaries(data: pd.DataFrame):
    """
    Test proper longitude and latitude boundaries for properties
    in and around NYC
    """
...
def test_similar_neigh_distrib(data: pd.DataFrame,
    ...
    of the new data is significantly different than that
...
def test_price_range(data, min_price, max_price):
    """Test if all price values are in a given range"""
